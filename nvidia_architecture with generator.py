...
#input_shape = (160, 320, 3)  # Trimmed image format
input_shape = (160, 160, 3)  # Trimmed image format
#input_shape= (160, 320)  # Trimmed image format
...
score = model.evaluate_generator(test_generator, steps=len(test_samples)/batch_size*2, max_queue_size=10, workers=1, use_multiprocessing=False)
